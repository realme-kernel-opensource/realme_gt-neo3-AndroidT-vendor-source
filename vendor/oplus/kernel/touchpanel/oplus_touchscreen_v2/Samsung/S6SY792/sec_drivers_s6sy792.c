...
static void sec_set_gesture_state(void *chip_data, int state)
{
	...
	SET_GESTURE_BIT(state, DOU_TAP, state_inchip, 8);
	SET_GESTURE_BIT(state, UP_VEE, state_inchip, 9);
	SET_GESTURE_BIT(state, DOWN_VEE, state_inchip, 10);
	SET_GESTURE_BIT(state, LEFT_VEE, state_inchip, 11);
	SET_GESTURE_BIT(state, RIGHT_VEE, state_inchip, 12);
	SET_GESTURE_BIT(state, CIRCLE_GESTURE, state_inchip, 13);
	SET_GESTURE_BIT(state, DOWN2UP_SWIP, state_inchip, 14);
	SET_GESTURE_BIT(state, UP2DOWN_SWIP, state_inchip, 15);
	SET_GESTURE_BIT(state, RIGHT2LEFT_SWIP, state_inchip, 0);
	SET_GESTURE_BIT(state, LEFT2RIGHT_SWIP, state_inchip, 1);
	SET_GESTURE_BIT(state, M_GESTRUE, state_inchip, 2);
	SET_GESTURE_BIT(state, W_GESTURE, state_inchip, 3);
	SET_GESTURE_BIT(state, DOU_SWIP, state_inchip, 4);
	SET_GESTURE_BIT(state, SINGLE_TAP, state_inchip, 5);
	SET_GESTURE_BIT(state, S_GESTURE, state_inchip, 6);
